    ...
    <div className="min-h-screen bg-dark-900 text-ink">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-10 pb-20">
        ...
        <Section title="3. Eligibility">
          <p>You must be at least <strong className="text-ink">13 years old</strong> to use Arjun. If you are under 18, you should have parental awareness before using this service.</p>
