    ...
    return (
      <div className="min-h-screen bg-dark-900 text-white">
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 py-10 pb-20">
          <div className="mb-10">
            <h1 className="text-4xl font-extrabold text-white mb-3">रिफंड और रद्दीकरण नीति</h1>
            <p className="text-slate-500 text-sm">अंतिम अपडेट: 19 जून 2026</p>
          </div>

          <Section title="1. हमारी योजनाएं">
            <p><strong className="text-white">14-दिन का मुफ़्त ट्रायल:</strong> नए खाते को पूरे 14 दिनों का पूर्ण Arjun कोचिंग एक्सेस मिलता है — बिना किसी क्रेडिट कार्ड के।</p>
            <p><strong className="text-white">मासिक प्रीमियम:</strong> ₹299/माह — हर 30 दिनों में स्वचालित रूप से नवीनीकृत होता है।</p>
            <p><strong className="text-white">वार्षिक प्रीमियम:</strong> ₹1999/वर्ष — एक बार बिल होता है, मासिक की तुलना में 44% की बचत।</p>
          </Section>
          ...
          <Section title="3. रिफंड नीति">
            <p>हम <strong className="text-white">14-दिन का पूर्ण निःशुल्क ट्रायल</strong> प्रदान करते हैं — कोई क्रेडिट कार्ड नहीं, कोई प्रतिबद्धता नहीं — ताकि आप सदस्यता लेने से पहले Arjun को पूरी तरह से आज़मा सकें।</p>
            <p>इस कारण से, एक बार भुगतान होने के बाद हम <strong className="text-white">आम तौर पर रिफंड नहीं</strong> देते।</p>
          ...
          <Section title="4. रद्द कैसे करें">
            <p>ऐप में: <strong className="text-white">खाता → सदस्यता → प्लान रद्द करें</strong></p>
            <p>ईमेल द्वारा: <a href="mailto:kamal.prabhanshu@outlook.com" className="text-brand-400 hover:text-brand-300 underline underline-offset-2">kamal.prabhanshu@outlook.com</a> पर लिखें — हम 2 कार्यदिवसों के भीतर जवाब देंगे।</p>
          </Section>

          <Section title="5. संपर्क करें">
            <p><strong className="text-white">Prabhanshu Kamal</strong><br />
            ईमेल: <a href="mailto:kamal.prabhanshu@outlook.com" className="text-brand-400 hover:text-brand-300 underline underline-offset-2">kamal.prabhanshu@outlook.com</a></p>
          ...
          <Section title="6. मानसिक स्वास्थ्य और संकट स्थितियां">
            <p>Arjun एक <strong className="text-white">मानसिक प्रदर्शन उपकरण</strong> है — कोई चिकित्सा सेवा, थेरेपी, या संकट हस्तक्षेप सेवा नहीं। अगर आप आत्म-नुकसान या मानसिक स्वास्थ्य आपातकाल के बारे में सोच रहे हैं, तो कृपया तुरंत एक पेशेवर से संपर्क करें।</p>
    ...
    <div className="min-h-screen bg-dark-900 text-white">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-10 pb-20">
        ...
        <Section title="1. Our plans">
          <p><strong className="text-white">14-day free trial:</strong> New accounts receive full Arjun coaching access for 14 days at no cost — no credit card required.</p>
          <p><strong className="text-white">Monthly premium:</strong> ₹299/month — renews automatically every 30 days.</p>
          <p><strong className="text-white">Annual premium:</strong> ₹1999/year — billed once per year, saving 44% vs monthly.</p>
        </Section>
        ...
        <Section title="3. Refund policy">
          <p>We offer a <strong className="text-white">14-day fully unlimited free trial</strong> — no credit card, no commitment — so you can experience Arjun fully before subscribing.</p>
          <p>Because of this, once payment has been made, we <strong className="text-white">generally do not offer refunds</strong>.</p>
        ...
        <Section title="4. How to cancel">
          <p>In the app: <strong className="text-white">Account → Subscription → Cancel Plan</strong></p>
          <p>By email: write to <a href="mailto:kamal.prabhanshu@outlook.com" className="text-brand-400 hover:text-brand-300 underline underline-offset-2">kamal.prabhanshu@outlook.com</a> and we will process your cancellation within 2 business days.</p>
        </Section>
        ...
        <Section title="6. Mental health and crisis situations">
          <p>Arjun is a <strong className="text-white">mental performance tool</strong> — not a medical service, therapy, or crisis intervention service. If you are experiencing thoughts of self-harm or a mental health emergency, please contact a professional immediately.</p>
