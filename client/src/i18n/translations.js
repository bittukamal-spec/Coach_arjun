...
export const translations = {
  en: {
    ...
    chat: {
      ...
      aiIntroTitle: 'Hi, I\'m Arjun — an AI coach',
      aiIntroBody: 'I\'m an AI software coach built to help athletes with focus, confidence, and pressure. I\'m not a human, therapist, or medical professional — just a performance tool that\'s always here for you.',
      aiIntroDismiss: 'Got it, let\'s start →',
  ...
  hi: {
    ...
    chat: {
      ...
      aiIntroTitle: 'नमस्ते, मैं अर्जुन हूं — एक AI कोच',
      aiIntroBody: 'मैं एक AI सॉफ्टवेयर कोच हूं जो एथलीटों की फोकस, आत्मविश्वास और दबाव में मदद करता है। मैं इंसान, थेरेपिस्ट या डॉक्टर नहीं हूं — बस एक प्रदर्शन उपकरण जो हमेशा आपके साथ है।',
      aiIntroDismiss: 'ठीक है, शुरू करें →',
