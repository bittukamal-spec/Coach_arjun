...
export const translations = {
  en: {
    ...
    mentalFitness: {
      ...
      subtitle: '6 questions · about 60 seconds',
      startBtn: "Let's go",
      ...
      card: {
        notDoneTitle: 'Mental check-in',
        notDoneSub:   "How's your head today? 60 seconds.",
        notDoneBtn:   'Check in',
        doneTitle:    'Mental game · today',
      },
    },
    common: {
      loading: 'Loading…',
  ...
  hi: {
    ...
    mentalFitness: {
      ...
      card: {
        notDoneTitle: 'मानसिक चेक-इन',
        notDoneSub:   'आज दिमाग कैसा है? 60 सेकंड।',
        notDoneBtn:   'चेक-इन करें',
        doneTitle:    'आज का मानसिक खेल',
      },
    },
    common: {
