...
export const translations = {
  en: {
    ...
    bounceBack: {
      pageTitle: 'Reset your head',
      arjunStep1: "I'm here. Tell me what happened.",
      situationLabel: 'What happened?',
      sit_played_badly: 'Played really badly',
      sit_big_mistake: 'Made a big mistake',
      sit_we_lost: 'We lost',
      sit_let_down: 'Let the team down',
      sit_other: 'Something else',
      intensityLabel: 'How much is it sitting with you?',
      intensityLow: 'A bit',
      intensityHigh: 'A lot',
      nextBtn: 'Next →',
      arjunStep2: "Let's slow things down first.",
      breathingSubtitle: 'Box breathing · 3 rounds',
      breathIn: 'Breathe in',
      hold: 'Hold',
      breathOut: 'Breathe out',
      breathDone: 'Well done.',
      skipBtn: 'Skip',
      arjunLoading: 'Arjun is thinking…',
      arjunStep4: "What's one thing you can control next time?",
      controlPlaceholder: 'e.g. My preparation, my attitude, my focus',
      finishBtn: 'Finish',
    },
  },
  ...
  hi: {
    ...
    bounceBack: {
      pageTitle: 'दिमाग रीसेट करो',
      arjunStep1: 'मैं यहाँ हूं। बताओ क्या हुआ।',
      situationLabel: 'क्या हुआ?',
      sit_played_badly: 'खेल बहुत खराब रहा',
      sit_big_mistake: 'बड़ी गलती हो गई',
      sit_we_lost: 'हम हार गए',
      sit_let_down: 'टीम को निराश किया',
      sit_other: 'कुछ और',
      intensityLabel: 'यह कितना सता रहा है?',
      intensityLow: 'थोड़ा',
      intensityHigh: 'बहुत',
      nextBtn: 'आगे →',
      arjunStep2: 'पहले थोड़ा शांत हो जाते हैं।',
      breathingSubtitle: 'बॉक्स ब्रीदिंग · 3 राउंड',
      breathIn: 'सांस लो',
      hold: 'रोको',
      breathOut: 'सांस छोड़ो',
      breathDone: 'बढ़िया।',
      skipBtn: 'छोड़ें',
      arjunLoading: 'अर्जुन सोच रहा है…',
      arjunStep4: 'अगली बार क्या एक चीज़ तुम्हारे control में है?',
      controlPlaceholder: 'जैसे: मेरी तैयारी, मेरा रवैया, मेरा फोकस',
      finishBtn: 'पूरा करें',
    },
  },
};
