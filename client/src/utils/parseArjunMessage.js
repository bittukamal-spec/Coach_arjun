...
const RAW_APP_TOOL_CONFIG = {
  ...
  'body-reset': {
    ...
    sub: 'Steady your body before the next action.',
  ...
  'self-talk': {
    ...
    sub: 'Turn pressure thoughts into one cue you can use in training or match.',
    why: 'Your own words beat borrowed motivation.',
    cta: 'Build Card',
    icon: 'MessageSquare',
    iconColor: '#185FA5',
    bgColor: '#EBF3FC',
  ...
  'focus-lock': {
    ...
    why: 'Practise using your focus words under distraction.',
    cta: 'Train focus words',
    icon: 'Target',
    iconColor: '#185FA5',
    bgColor: '#EBF3FC',
  ...
  'focus-deck': {
    label: 'Saved Focus Words',
    sub: 'Your saved focus words',
    why: 'Review the focus words and phrases you already built.',
    cta: 'View cards',
    icon: 'Layers',
    iconColor: '#185FA5',
    bgColor: '#EBF3FC',
  ...
  'skill-focus-self-talk': {
    label: 'Focus / Focus Words',
    sub: 'Learn how to bring your mind back to one focus word.',
    why: 'A short path to build and practise your own focus words.',
    cta: 'Start now',
    icon: 'GraduationCap',
    iconColor: '#185FA5',
    bgColor: '#EBF3FC',
